    ...
    (prefixesArray = e || ["fa"]),
      ...
      Array.prototype.forEach.call(t, function (e) {
        (n = e.getAttribute("title")),
          ...
          n &&
            i &&
            (((o = document.createElement("span")).innerHTML = n), o.classList.add("sr-only"), e.parentNode.insertBefore(o, e.nextSibling));
      });
  }
  var d = function (e, t) {
    ...
    c = function (e, t) {
      !(function (e, t) {
        ...
        if ((t && t.detectingConflicts && t.detectionIgnoreAttr && a.setAttributeNode(document.createAttribute(t.detectionIgnoreAttr)), i))
          n = i;
        else {
        ...
        "css" === f.method &&
          (function (e, t) {
            ...
            e.autoA11y.enabled &&
              (r(i),
              (n = i),
              "undefined" != typeof MutationObserver && new MutationObserver(n).observe(document, { childList: !0, subtree: !0 })),
              e.v4shim.enabled &&
                (e.license,
